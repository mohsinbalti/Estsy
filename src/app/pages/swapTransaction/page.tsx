...
const PageTransaction = () => {
  return (
    <div>
      <section className="hero-area heroShapeNone relative pt-24 lg:pt-40 pb-20 lg:pb-44">
        ...
        <div className="container">
          <div className="hero-content max-w-6xl mx-auto text-center relative z-10">
            ...
            <form
              ...
              className="swap-transaction active cryptocurrency-platform borderAnimate2 bordered border-gradient px-4 xl:px-6 py-8 xl:py-16"
            >
                    ...
                    <div className="col-span-6">
                      <div className="flex items-center text-start gap-3">
                        ...
                        <div>
                          ...
                          <h4 className="text-sm xl:text-2xl font-normal">
                            {" "}
                            0.5 BTC{" "}
                          </h4>
                        </div>
      ...
      <section className="cryptocurrency-area pb-20 lg:pb-44">
        <div className="container">
          <div className="about-content max-w-5xl">
            <h4 className="text-2xl lg:text-4xl font-bold mb-8">
              Useful tips to know
            </h4>
            <ul className="list-square ps-5 mb-6">
              <li>
